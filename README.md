<h1>
   ...
   APRES QUELQUES RECHERCHES, J'AI TROUVÉ QUE C'ÉTAIT PLUS SIMPLE DE FAIRE GNL AVEC DES STRUCTS , RENSEIGNEZ VOUS SUR LES STRUCTS C'EST VRAIMENT PLUS SIMPLE!
    </h4>
</h1>
